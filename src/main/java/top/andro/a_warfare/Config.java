...
import top.andro.a_warfare.client.SwayType;
import top.andro.a_warfare.client.render.crosshair.DotRenderMode;
import top.andro.a_warfare.client.screen.ButtonAlignment;
import top.andro.a_warfare.entity.projectile.turret.TurretProjectileEntity;
    ...
    public static class Display
    {
        ...
        public Display(ForgeConfigSpec.Builder builder)
        {
            builder.comment("Configuration for display related options").push("display");
            {
                ...
                this.crosshair = builder.comment("The custom crosshair to use for weapons. Go to (Options > Controls > Mouse Settings > Crosshair) in game to change this!").define("crosshair", "a_warfare:dynamic");
