...
import static top.andro.a_warfare.blockentity.PoweredMechanicalPressBlockEntity.MOLD_SLOT;
...
public class PoweredMechanicalPressRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Serializer implements RecipeSerializer<PoweredMechanicalPressRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation("a_warfare", "powered_mechanical_pressing");
