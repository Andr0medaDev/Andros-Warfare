package top.andro.a_warfare.client.util;
...
import top.andro.a_warfare.cache.ObjectCache;
import top.andro.a_warfare.client.MetaLoader;
import top.andro.a_warfare.common.Gun;
import top.andro.a_warfare.common.properties.SightAnimation;
import top.andro.a_warfare.item.IMeta;
import top.andro.a_warfare.item.attachment.IAttachment;
import top.andro.a_warfare.item.attachment.IBarrel;
import top.andro.a_warfare.item.attachment.IScope;
...
public final class PropertyHelper
{
    ...
    public static final String MODEL_KEY = "a_warfare:model";
    public static final String WEAPON_KEY = "a_warfare:weapon";
    public static final String SCOPE_KEY = "a_warfare:scope";
    public static final String BARREL_KEY = "a_warfare:barrel";
