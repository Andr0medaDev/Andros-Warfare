...
import top.andro.a_warfare.event.GunReloadEvent;
...
import top.andro.a_warfare.network.message.C2SMessageLeftOverAmmo;
    ...
    public static void loaded(Player player) {
        ...
        if (item instanceof GunItem gunItem) {
            ...
            if (gun.getReloads().getReloadType() == ReloadType.MANUAL) {
                if (tag.getBoolean("a_warfare:ReloadComplete")) {
                    if (!tag.getBoolean("a_warfare:IsPlayingReloadStop")) {
