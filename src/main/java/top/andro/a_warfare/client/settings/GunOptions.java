package top.andro.a_warfare.client.settings;
...
public class GunOptions
{
    ...
    /*public static final ProgressOption ADS_SENSITIVITY = new GunSliderPercentageOption("a_warfare.options.adsSensitivity", 0.0, 1.0, 0.01F, gameSettings -> {
        ...
        return new TranslatableComponent("a_warfare.options.adsSensitivity.format", FORMAT.format(adsSensitivity));
    });

    public static final CycleOption<ResourceLocation> CROSSHAIR = CycleOption.create("a_warfare.options.crosshair", () -> {
    ...
    public static final Option CROSSHAIR = CycleOption.create("a_warfare.options.crosshair", () -> {
