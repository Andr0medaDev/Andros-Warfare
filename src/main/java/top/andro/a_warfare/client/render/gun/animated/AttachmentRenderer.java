...
public class AttachmentRenderer extends GeoRenderLayer<AnimatedGunItem> {
    ...
    public void updateAttachment(ItemStack attachmentStack) {
        ...
        model_resource = new ResourceLocation("a_warfare", "geo/item/attachment/" + attachmentStack.getItem() + ".geo.json");
        texture_resource = new ResourceLocation("a_warfare", "textures/animated/attachment/" + attachmentStack.getItem() + ".png");
