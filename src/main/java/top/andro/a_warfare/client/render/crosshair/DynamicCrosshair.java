package top.andro.a_warfare.client.render.crosshair;
...
import top.andro.a_warfare.client.handler.AimingHandler;
...
import top.andro.a_warfare.util.GunCompositeStatHelper;

//Thanks to Miga!
public class DynamicCrosshair extends Crosshair {
    private static final ResourceLocation DYNAMIC_CROSSHAIR_H = new ResourceLocation("a_warfare", "textures/crosshair/dynamic_horizontal.png");
    private static final ResourceLocation DYNAMIC_CROSSHAIR_V = new ResourceLocation("a_warfare", "textures/crosshair/dynamic_vertical.png");
    private static final ResourceLocation DOT_CROSSHAIR = new ResourceLocation("a_warfare", "textures/crosshair/dot.png");
    private float scale;
    ...
    public DynamicCrosshair() {
        super(new ResourceLocation("a_warfare", "dynamic"));
    }
