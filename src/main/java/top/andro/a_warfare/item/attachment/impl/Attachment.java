...
public abstract class Attachment
{
    ...
    public static void addInformationEvent(ItemTooltipEvent event)
    {
        ...
        if(stack.getItem() instanceof IAttachment<?>)
        {
            ...
            {
                event.getToolTip().add(Component.translatable("perk.a_warfare.title").withStyle(ChatFormatting.GRAY, ChatFormatting.BOLD));
            ...
            {
                addPerk(negativePerks, false, "perk.a_warfare.fire_volume.negative");
            }
            else if(outputSound < inputSound)
            {
                addPerk(positivePerks, true, "perk.a_warfare.fire_volume.positive");
            }
            ...
            for(IGunModifier modifier : modifiers)
            {
                ...
                {
                    addPerk(positivePerks, true, "perk.a_warfare.silenced.positive");
                    break;
                }
            }
            ...
            {
                addPerk(negativePerks, false, "perk.a_warfare.sound_radius.negative");
            }
            else if(outputRadius < inputRadius)
            {
                addPerk(positivePerks, true, "perk.a_warfare.sound_radius.positive");
            }
            ...
            if (criticalChance > 0.0F) {
                addPerk(positivePerks, true, "perk.a_warfare.critical_chance.positive", ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format(criticalChance * 100) + "%");
            } else if (criticalChance < 0.0F) {
                addPerk(negativePerks, false, "perk.a_warfare.critical_chance.negative", ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format(criticalChance * 100) + "%");
            }
            ...
            {
                addPerk(positivePerks, true, "perk.a_warfare.additional_damage.positive", ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format(additionalDamage / 2.0));
            }
            else if(additionalDamage < 0.0F)
            {
                addPerk(negativePerks, false, "perk.a_warfare.additional_damage.negative", ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format(additionalDamage / 2.0));
            }
            ...
            {
                addPerk(positivePerks, true, "perk.a_warfare.modified_damage.positive");
            }
            else if(outputDamage < inputDamage)
            {
                addPerk(negativePerks, false, "perk.a_warfare.modified_damage.negative");
            }
            ...
            {
                addPerk(positivePerks, true, "perk.a_warfare.projectile_speed.positive");
            }
            else if(outputSpeed < inputSpeed)
            {
                addPerk(negativePerks, false, "perk.a_warfare.projectile_speed.negative");
            }
            ...
            {
                addPerk(negativePerks, false, "perk.a_warfare.projectile_spread.negative");
            }
            else if(outputSpread < inputSpread)
            {
                addPerk(positivePerks, true, "perk.a_warfare.projectile_spread.positive");
            }
            ...
            {
                addPerk(positivePerks, true, "perk.a_warfare.projectile_life.positive");
            }
            else if(outputLife < inputLife)
            {
                addPerk(negativePerks, false, "perk.a_warfare.projectile_life.negative");
            }
            ...
            {
                addPerk(negativePerks, false, "perk.a_warfare.recoil.negative");
            }
            else if(outputRecoil < inputRecoil)
            {
                addPerk(positivePerks, true, "perk.a_warfare.recoil.positive");
            }
            ...
            {
                addPerk(positivePerks, true, "perk.a_warfare.ads_speed.positive");
            }
            else if(outputAdsSpeed < inputAdsSpeed)
            {
                addPerk(negativePerks, false, "perk.a_warfare.ads_speed.negative");
            }
            ...
            {
                addPerk(negativePerks, false, "perk.a_warfare.rate.negative");
            }
            else if(outputRate < inputRate)
            {
                addPerk(positivePerks, true, "perk.a_warfare.rate.positive");
            }
            ...
            if (outputReloadSpeed < inputReloadSpeed) {
                addPerk(positivePerks, true, "perk.a_warfare.reload_speed.positive");
            } else if (outputReloadSpeed > inputReloadSpeed) {
                addPerk(negativePerks, false, "perk.a_warfare.reload_speed.negative");
            }
            ...
            if (outputAmmoCapacity > baseAmmoCapacity) {
                addPerk(positivePerks, true, "perk.a_warfare.ammo_capacity.increase", ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format((outputAmmoCapacity - baseAmmoCapacity)));
            } else if (outputAmmoCapacity < baseAmmoCapacity) {
                addPerk(negativePerks, false, "perk.a_warfare.ammo_capacity.decrease", ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format((baseAmmoCapacity - outputAmmoCapacity)));
            }
    ...
    private static void addPerk(List<Component> components, boolean positive, String id, Object... params) {
        components.add(Component.translatable(positive ? "perk.a_warfare.entry.positive" : "perk.a_warfare.entry.negative", Component.translatable(id, params).withStyle(ChatFormatting.WHITE)).withStyle(positive ? ChatFormatting.DARK_AQUA : ChatFormatting.GOLD));
    }
}
