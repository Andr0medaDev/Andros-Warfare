...
public class AnimatedUnderWaterGunItem extends AnimatedGunItem{
    public AnimatedUnderWaterGunItem(Properties properties, String path, SoundEvent reloadSoundMagOut, SoundEvent reloadSoundMagIn, SoundEvent reloadSoundEnd, SoundEvent boltPullSound, SoundEvent boltReleaseSound) {
