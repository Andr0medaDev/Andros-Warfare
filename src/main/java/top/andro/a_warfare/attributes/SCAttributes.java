...
public class SCAttributes {
    ...
    //        () -> new RangedAttribute("attribute.a_warfare.bullet_resistance", 0.0, 0, 100.0)
    //                .setSyncable(true)
    //);
    public static final RegistryObject<Attribute> SPREAD_MULTIPLIER = ATTRIBUTES.register("spread_multiplier",
            () -> new RangedAttribute("attribute.a_warfare.spread_multiplier", 1.0, 0, 1000.0)
                    .setSyncable(true)
    );
}